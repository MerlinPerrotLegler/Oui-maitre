...
export class ChatsController {
  ...
  @Get(':id')
  get(@Param('id') id: string) { return this.chats.get(id); }
  ...
  editMessage(@Param('id') id: string, @Param('messageId') messageId: string, @Body() body: { content: string }) {
    return this.chats.editMessage(id, messageId, body.content);
  }

  @Delete(':id/messages/:messageId')
  deleteMessage(@Param('id') id: string, @Param('messageId') messageId: string) {
    return this.chats.deleteMessage(id, messageId);
  }
}
